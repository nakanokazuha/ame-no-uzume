...
The repository contains design and plans but no implementation. Read `docs/superpowers/specs/2026-07-27-yume-dashboard-design.md`, then `docs/superpowers/plans/2026-07-27-yume-dashboard-roadmap.md`. Execute the core plan before the optional bridge or production assets. Treat plan gates as requirements; update documentation when implementation diverges.
